  ...
  return (
    <div className=' bg-homeBg min-h-screen brightness-100 bg-cover'>
      ...
      <div className=" text-white flex flex-col justify-center items-center gap-20" >
        ...
        <p  data-aos='zoom-in' className='flex flex-col justify-center items-center text-center pt-20 text-white'><span className='text-7xl'>Make A Statement</span> <span className='text-8xl'>WITHOUT SAYING</span><span className='text-9xl'>A WORD</span></p>
